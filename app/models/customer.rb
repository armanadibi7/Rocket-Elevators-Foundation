class Customer < ApplicationRecord
    ...
    def just_created
        # url = authenticator.authorize_url :redirect_uri => 'http://localhost:3000/dropbox/auth_callback'
    ...
    #   DropboxApi::Authenticator.new(ENV['dropbox_clienId'], ENV['dropbox_secret'])
    # end
